...
//Adafruit_StepperMotor *myMotor = AFMS.getStepper(360, 1);
...
{  if (Serial.available() > 0){
    ...
    //myMotor->step(360, BACKWARD, DOUBLE);
    ...
    for(int i=0; i<SAMPLES; i++)
    {
        ...
        vReal[i] = analogRead(mic); //Reads the value from analog pin 0 (A0), quantize it and save it as a real term.
